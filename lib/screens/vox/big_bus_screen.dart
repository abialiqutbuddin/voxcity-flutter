...
class BigBusBookingPage extends StatefulWidget {
  const BigBusBookingPage({super.key});

  @override
  BookingPageState createState() => BookingPageState();
}

class BookingPageState extends State<BigBusBookingPage> {
  ...
  void handleBooking() async {
    ...
    try {
      ...
      final result = await Wave.sendBookingData(emailTemplate: details,optionId: '85');
